  ...
  return (
    <div className="page">
      ...
      <form action="action.php">
        ...
        <input class="btn btn-primary me-4 mt-4 mb-2 btn-lg" type="button" value="Submit"></input>
        <input class="btn btn-danger ms-4 mt-4 mb-2 btn-lg" type="button" value="Reset"></input>
      </form>
